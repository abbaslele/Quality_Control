...
RadioButton {
    ...
    indicator: Rectangle {
        ...
        // blank or transparent indicator when number button
        //width: 0; height: 0
    }
    ...
    states:[
        ...
        State{
            ...
            PropertyChanges { target: uIndicator; color:mNormalBGColor }
        ...
        State{
            ...
            PropertyChanges { target: uIndicator; color:mBGOnStateColor }
